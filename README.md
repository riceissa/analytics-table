...
### Install Google Analytics API library, MySQL connector, and adjustText

Run:

```bash
sudo pip install --upgrade google-api-python-client mysql-connector-python adjustText
```
